...
const LogIn = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-warning/20">
        ...
        >
          ...
          <div className="flex items-center justify-between mb-2 text-[0.7rem]">
            <div className="flex items-center">
              ...
              />
              <label className="text-text ml-2 mt-1">Remember me</label>
            </div>
            <div>
              <p className="text-primary underline mt-1">Forgot Password?</p>
            </div>
          </div>
          <button
            type="submit"
